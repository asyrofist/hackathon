...
<?php
$type = "Blue PET bottle - not clean";
...
$regression->train($samples, $targets3);
...
$dataPoints = array(
	...
	array("x"=> 15, "y"=> 2000),
	array("x"=> 16, "y"=> 1000),
	array("x"=> 17, "y"=> 1000, "indexLabel"=> "Predicted"),
	array("x"=> 18, "y"=> 1000),
	array("x"=> 19, "y"=> 1200),
	array("x"=> 20, "y"=> 1200),
  array("x"=> 21, "y"=> 1300),
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "Blue PET bottle - not clean"
	},
	data: [{
...
echo "<br/>Blue PET bottle - not clean";
echo "<br/>";
$tahun = 2018;
for($i=0; $i < 12 ; $i++){
