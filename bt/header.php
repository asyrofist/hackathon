    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?halaman=services">Bank Sampah</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?halaman=contact">Contact</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?halaman=pricing">Harga</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?halaman=bergabung">Cara bergabung</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?halaman=contact">Contact</a>
          </li>
          ...
          <li class="nav-item active dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
              ...
              <a class="dropdown-item" href="index.php?halaman=sidebar">Sidebar Page</a>
              <a class="dropdown-item" href="index.php?halaman=faq">FAQ</a>
              <a class="dropdown-item active" href="index.php?halaman=404">404</a>
              <a class="dropdown-item" href="index.php?halaman=pricing">Pricing Table</a>
            </div>
          </li>
        </ul> -->
      </div>
